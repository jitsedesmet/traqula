...
import {
  ...
  substringExpression,
} from '@traqula/rules-sparql-1-1/lib/grammar/builtIn';
import {
  additiveExpression,
  argList,
  ...
  unaryExpression,
  valueLogical,
} from '@traqula/rules-sparql-1-1/lib/grammar/expression';
import { var_ } from '@traqula/rules-sparql-1-1/lib/grammar/general';
import {
  booleanLiteral,
  iri,
  numericLiteral,
